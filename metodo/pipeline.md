...
La **madre intermedia** de una cadena de keyframes (§2 paso 1) usa el sufijo de letra sobre la madre base (`a3-m10` → `a3-m10a`, `a3-m10b`): declara su linaje sin renumerar la serie.
