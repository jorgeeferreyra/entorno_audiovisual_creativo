...
> Alcance completo de la herramienta contra el que se mide: [toolkit-wind-comic.md](toolkit-wind-comic.md). Flujo recomendado actual: [pipeline-wind-comic.md](pipeline.md).
