...
> Fuente del aspecto: `prompt_charles_jones.txt` (raíz del proyecto). Se toma solo el aspecto físico y el vestuario; el framing de ese prompt (fotorrealista 8K, atmósfera tipo The Revenant) **NO se adopta**: el registro del proyecto es cuaderno ilustrado ([biblia-visual.md](biblia-visual.md) §1).
...
- styleKeywords (EN): illustrated documentary, reconstructed notebook, victorian exploration
...
- appearance (EN): A realistic yet endearing adult female platypus, warm brown fur, soft expressive eyes, calm gentle movements.
- styleKeywords (EN): illustrated documentary, reconstructed notebook
...
- appearance (EN): A small baby platypus, playful and curious, slightly lighter fur than its mother, big curious eyes.
- styleKeywords (EN): illustrated documentary, reconstructed notebook
...
- appearance (EN): A realistic yet endearing adult male platypus, subtly distinct from the mother: slightly darker fur and a small scar over one eye.
- styleKeywords (EN): illustrated documentary, reconstructed notebook
