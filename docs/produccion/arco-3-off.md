...
> Texto literal del **off documental** del Arco 3, listo para grabar (voz propia) o TTS. Antes solo existían indicaciones por clip en [arco-3-planos.md](arco-3-planos.md) ("off documental (presenta la familia)"); acá está la locución palabra por palabra.
