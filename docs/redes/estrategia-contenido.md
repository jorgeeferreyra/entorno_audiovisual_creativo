...
> Qué contamos y en qué formato. El "cómo producirlo" vive en [produccion/pipeline-wind-comic.md](../produccion/pipeline-wind-comic.md). El canon está en [biblia-serie.md](../biblia-serie.md).
