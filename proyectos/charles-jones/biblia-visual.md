...
5. **Secuencia de madres por clip (keyframes)**: la regla general (cuántas madres pide cada escena — 1 / 2 / N keyframes, la técnica de cadena de eslabones FLF con keyframe compartido, la regla anti-inflación de costo y el gate propio de pares/cadenas aprobados juntos) vive en [pipeline.md](../../metodo/pipeline.md) §2 paso 1.75 y no se duplica acá. Aplicación en el Arco 3: los pares emparejados de la regla 4 (`a3-m05`→`a3-m06`, `a3-m10`→`a3-m11`) son los casos de 2 keyframes; las cadenas concretas del arco viven en [arco-3-planos.md](redes/planos/arco-3.md) §Cadena de transiciones.
